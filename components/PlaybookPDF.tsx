...
export function BrandPlaybook(props: BrandPlaybookProps) {
  ...
  return (
    ...
    >
      {/* ============ 01 / COVER ============
          Logo-led editorial cover (matches the brand reference):
            - eyebrow strip at the top (publisher meta)
            - the actual brand logo, shown prominently
            - large wordmark "name." with accent dot
            - italic tagline beneath
            - palette signature strip + meta block at the bottom
          The Nano Banana cover image is no longer the hero — the logo is.
      */}
      <Page size="A4" style={styles.page}>
        ...
        {/* Logo-led lockup block — vertically centered in the upper 2/3 */}
        <View
          style={{
            marginTop: 90,
            alignItems: "flex-start",
      ...
      <Page size="A4" style={styles.page}>
        ...
        {/* Row 3 — Palette signature + Essence (4 principles compressed) */}
        <View style={{ flexDirection: "row", gap: 6, marginBottom: 6, height: 130 }}>
          {/* Palette signature strip (replaces the old pattern strip) */}
          <View
            style={{
              flex: 1,
              backgroundColor: COLORS.ink,
...
export function CampaignPlaybook(props: CampaignPlaybookProps) {
  ...
  return (
    ...
    >
      {/* ============ 01 / COVER ============
          Logo-led campaign cover — leads with the parent brand logo and
          the campaign wordmark, not a photographic hero. */}
      <Page size="A4" style={styles.page}>
        <View
          style={{
            flexDirection: "row",
